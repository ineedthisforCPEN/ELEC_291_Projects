            ...
            switch($function) {
                ...
                case 'addcomp':
                    ...
                    echo "<div class=\"alert alert-success\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\" onClick=\"location.href='../'\">&times;</a>" .
                         "Added <b>\"" . $text . "\"</b> to compliments list</a></div>";
                    break;
                case 'addcompfail':
                ...
                case 'remcomp':
                    ...
                    // Exiting the alert will bring the user back to the main page
                    echo "<div class=\"alert alert-success\"><a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\" onClick=\"location.href='../'\">&times;</a>" .
                         "Removed <b>\"" . $text . "\"</b> from compliments list</a></div>";
                    break;
                case 'remcompfail':
            ...
            <div class="col-md-4">
	           ...
	           <!-- Section for time (By James) -->
                ...
                <div class="well well-sm">
                    ...
                    <p style="padding-left: 5%; font-size: 180%;"><?php echo $owmCity; ?><small style="color: #888888;"><?php echo "\t" . $owmCountry; ?></small></p>
